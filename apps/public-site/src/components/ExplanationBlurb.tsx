  ...
  switch (type) {
    case "coffee":
      return params.coffeeId
        ? `${API_BASE}/api/v1/explain/coffee/${params.coffeeId}`
        : null;
    case "compare":
      return params.ids
        ? `${API_BASE}/api/v1/explain/compare?ids=${encodeURIComponent(params.ids)}`
        : null;
    case "origin":
      return params.country
        ? `${API_BASE}/api/v1/explain/origin/${encodeURIComponent(params.country)}`
        : null;
    case "roaster":
      return params.roasterId
        ? `${API_BASE}/api/v1/explain/roaster/${params.roasterId}`
        : null;
    case "search":
      return params.q && params.coffeeId
        ? `${API_BASE}/api/v1/explain/search?q=${encodeURIComponent(params.q)}&coffee_id=${params.coffeeId}`
        : null;
    default:
      return null;
  }
